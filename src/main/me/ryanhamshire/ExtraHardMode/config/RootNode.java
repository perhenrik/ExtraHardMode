...
public enum RootNode implements ConfigNode
{
    ...
    STANDARD_TORCH_MIN_Y
            ("ExtraHardMode.World Rules.Torches.Max Y", VarType.INTEGER, SubType.Y_VALUE, 30),
    /**
    ...
    BROKEN_NETHERRACK_CATCHES_FIRE_PERCENT
            ("ExtraHardMode.World Rules.Breaking Netherrack Starts Fire Percent", VarType.INTEGER, SubType.PERCENTAGE, 20),
    /**
    ...
    PLAYER_DEATH_ITEM_STACKS_FORFEIT_PERCENT
            ("ExtraHardMode.Player.Death.Item Stacks Forfeit Percent", VarType.INTEGER, SubType.PERCENTAGE, 10),
    /**
     * how much health after respawn
     */
    PLAYER_RESPAWN_HEALTH
            ("ExtraHardMode.Player.Death.Respawn Health", VarType.INTEGER, SubType.HEALTH, 15),
    /**
     * how much food bar after respawn
     */
    PLAYER_RESPAWN_FOOD_LEVEL
            ("ExtraHardMode.Player.Death.Respawn Foodlevel", VarType.INTEGER, SubType.HEALTH, 15),
    /**
     * whether players may swim while wearing armor
     */
    NO_SWIMMING_IN_ARMOR
            ("ExtraHardMode.Player.No Swimming When Too Heavy.Enable", VarType.BOOLEAN, true),
    /**
     * Block Swimming Up WaterFalls/WaterElevators
     */
    NO_SWIMMING_IN_ARMOR_BLOCK_ELEVATORS
            ("ExtraHardMode.Player.No Swimming When Too Heavy.Block Elevators/Waterfalls", VarType.BOOLEAN, true),
    /**
     * The maximum amount of points you can have before being too heavy
     */
    NO_SWIMMING_IN_ARMOR_MAX_POINTS
            ("ExtraHardMode.Player.No Swimming When Too Heavy.Max Points", VarType.DOUBLE, 18.0),
    /**
     * The amount of points a piece of armor adds to the max
     */
    NO_SWIMMING_IN_ARMOR_ARMOR_POINTS
            ("ExtraHardMode.Player.No Swimming When Too Heavy.One Piece Of Worn Armor Adds", VarType.DOUBLE, 2.0),
    /**
     * The amount of points that stuff in your inventory adds to the max
     */
    NO_SWIMMING_IN_ARMOR_INV_POINTS
            ("ExtraHardMode.Player.No Swimming When Too Heavy.One Stack Adds", VarType.DOUBLE, 1.0),
    /**
     * How much a tool or item which doesn't stack adds to the max
     */
    NO_SWIMMING_IN_ARMOR_TOOL_POINTS
            ("ExtraHardMode.Player.No Swimming When Too Heavy.One Tool Adds", VarType.DOUBLE, 0.5),
    /**
     * How fast do you drown, 100 (percent) = you drown no chance, 25 there is a chance you'll drown
     */
    NO_SWIMMING_IN_ARMOR_DROWN_RATE
            ("ExtraHardMode.Player.No Swimming When Too Heavy.Drown Rate", VarType.INTEGER, 25),
    /**
     * How much do you drown faster per weight over the max
     */
    NO_SWIMMING_IN_ARMOR_ENCUMBRANCE_EXTRA
            ("ExtraHardMode.Player.No Swimming When Too Heavy.Overencumbrance Adds To Drown Rate", VarType.INTEGER, 2),
     ...
     */
    MORE_MONSTERS_MAX_Y
            ("ExtraHardMode.General Monster Rules.More Monsters.Max Y", VarType.INTEGER, SubType.Y_VALUE, 55),
    /**
    ...
    MONSTER_SPAWNS_IN_LIGHT_MAX_Y
            ("ExtraHardMode.General Monster Rules.Monsters Spawn In Light Max Y", VarType.INTEGER, SubType.Y_VALUE, 50),
    ...
    ZOMBIES_REANIMATE_PERCENT
            ("ExtraHardMode.Zombies.Reanimate Percent", VarType.INTEGER, SubType.PERCENTAGE, 50),

    /**
     * percent chance skeletons have a chance to knock back targets with arrows
     */
    SKELETONS_KNOCK_BACK_PERCENT
            ("ExtraHardMode.Skeletons.Arrows Knockback Percent", VarType.INTEGER, SubType.PERCENTAGE, 30),
    /**
     * percent chance skeletons will release silverfish instead of firing arrows
     */
    SKELETONS_RELEASE_SILVERFISH
            ("ExtraHardMode.Skeletons.Shoot Silverfish Percent", VarType.INTEGER, SubType.PERCENTAGE, 30),
    /**
     * whether or not arrows will pass harmlessly through skeletons
     */
    SKELETONS_DEFLECT_ARROWS
            ("ExtraHardMode.Skeletons.Deflect Arrows Percent", VarType.INTEGER, SubType.PERCENTAGE, 100),
    /**
    ...
    SILVERFISH_DROP_COBBLE
            ("ExtraHardMode.Silverfish.Drop Cobble", VarType.BOOLEAN, true),

    /**                                                                  , List
     * percentage of zombies which will be replaced with spiders under sea level
     */
    BONUS_UNDERGROUND_SPIDER_SPAWN_PERCENT
            ("ExtraHardMode.Spiders.Bonus Underground Spawn Percent", VarType.INTEGER, SubType.PERCENTAGE, 20),
    /**
    ...
    CHARGED_CREEPER_SPAWN_PERCENT
            ("ExtraHardMode.Creepers.Charged Creeper Spawn Percent", VarType.INTEGER, SubType.PERCENTAGE, 10),
    /**
     * percentage of creepers which spawn activated TNT on death
     */
    CREEPERS_DROP_TNT_ON_DEATH_PERCENT
            ("ExtraHardMode.Creepers.Drop Tnt On Death.Percent", VarType.INTEGER, SubType.PERCENTAGE, 20),
    /**
     * max y for creepers to drop tnt, to restrict them to caves
     */
    CREEPERS_DROP_TNT_ON_DEATH_MAX_Y
            ("ExtraHardMode.Creepers.Drop Tnt On Death.Max Y", VarType.INTEGER, SubType.Y_VALUE, 50),
    /**
    ...
    NEAR_BEDROCK_BLAZE_SPAWN_PERCENT
            ("ExtraHardMode.Blazes.Near Bedrock Spawn Percent", VarType.INTEGER, SubType.PERCENTAGE, 50),
    /**
     * percentage of pig zombies which will be replaced with blazes
     */
    BONUS_NETHER_BLAZE_SPAWN_PERCENT
            ("ExtraHardMode.Blazes.Bonus Nether Spawn Percent", VarType.INTEGER, SubType.PERCENTAGE, 20),
    /**
    ...
    NETHER_BLAZES_SPLIT_ON_DEATH_PERCENT
            ("ExtraHardMode.Blazes.Nether Split On Death Percent", VarType.INTEGER, SubType.PERCENTAGE, 25),
    ...
    FLAME_SLIMES_SPAWN_WITH_NETHER_BLAZE_PERCENT
            ("ExtraHardMode.MagmaCubes.Spawn With Nether Blaze Percent", VarType.INTEGER, SubType.PERCENTAGE, 100),
    /**
    ...
    NETHER_PIGS_DROP_WART
            ("ExtraHardMode.PigZombies.Percent Chance to Drop Netherwart Elsewhere In Nether", VarType.INTEGER, SubType.PERCENTAGE, 0),
    ...
    WITCHES_ADDITIONAL_ATTACKS
            ("ExtraHardMode.Witches.Additional Attacks", VarType.BOOLEAN, true),
    /**
     * percentage of surface zombies which spawn as witches
     */
    BONUS_WITCH_SPAWN_PERCENT
            ("ExtraHardMode.Witches.Bonus Spawn Percent", VarType.INTEGER, SubType.PERCENTAGE, 5),
    ...
    WEAK_FOOD_CROPS_LOSS_RATE
            ("ExtraHardMode.Farming.Weak Crops.Loss Rate", VarType.INTEGER, SubType.PERCENTAGE, 25),
    /**
