...
public class DataStore {
   ...
   private void loadMessages() {
      ...
      this.addDefault(defaults, CustomizableMessage.Type.NoCraftingMelonSeeds, "That appears to be seedless!", null);
      this.addDefault(defaults, CustomizableMessage.Type.LimitedEndBuilding,
            "Sorry, building here is very limited.  You may only break blocks to reach ground level.", null);
      this.addDefault(defaults, CustomizableMessage.Type.DragonFountainTip,
            "Congratulations on defeating the dragon!  If you can't reach the fountain to jump into the portal, throw an ender pearl at it.", null);
      this.addDefault(defaults, CustomizableMessage.Type.NoSwimmingInArmor, "You're carrying too much weight to swim!", null);
