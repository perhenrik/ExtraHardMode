			...
			{				
				for(int y = chunk.getWorld().getMaxHeight() - 1; y > 0; y--)
				{
					...
					if(blockType != Material.AIR)
					{
						...
						else if(Config.Farming__Weak_Food_Crops__Enable && (blockType == Material.CROPS || blockType == Material.MELON_STEM || blockType == Material.CARROT || blockType == Material.PUMPKIN_STEM || blockType == Material.POTATO || blockType == Material.RED_ROSE || blockType == Material.YELLOW_FLOWER || blockType == Material.LONG_GRASS))
						{
							Biome biome = block.getBiome();
